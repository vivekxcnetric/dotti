  ...
  return (
    <Container>
      ...
      <FormContainer>
        <FormWrapper>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: "10px", display: "flex", gap: "10px" }}>
              ...
              <div>
                <label htmlFor="terms">
                  Sign up to Dotti emails and receive 15% off your next full
                  price purchase at Dotti.
                </label>
              </div>
            </div>
        ...
        <ImageWrapper>
          <img src="https://dotti.jgl.com.au/DT/aurora/images/espot/static/createaccount/DT_DESKTP_CreateAccount.png?impolicy=scale" />
        </ImageWrapper>
      </FormContainer>
    </Container>
  );
